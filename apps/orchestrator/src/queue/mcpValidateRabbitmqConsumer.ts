...
export type McpValidateQueueConsumerChannel = {
...
export type McpValidateQueueConnection = {
  createConfirmChannel(): Promise<McpValidateQueueConsumerChannel>;
  close(): Promise<void>;
};

export type McpValidateQueueConsumer = {
  start(): Promise<void>;
  stop(): Promise<void>;
};
...
export async function createMcpValidateRabbitMqConsumer(
  ...
  return {
    async start(): Promise<void> {
      ...
      connection = await amqp.connect(rabbitmqUrl) as unknown as McpValidateQueueConnection;
