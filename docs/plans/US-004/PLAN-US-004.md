# PLAN-US-004: Policy Engine Pre-Publish Guardrail

status: approved

## Goal

Provide a checker-compatible AI-SDLC plan wrapper for US-004. The detailed historical implementation plan remains in `docs/plans/US-004/US-004-implementation-plan.md`.
...
- AC-004: `npm run ai-sdlc:check -- US-004` passes.
