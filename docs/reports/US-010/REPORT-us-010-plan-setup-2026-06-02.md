...
|:---|:---|:---|
| Spec approved | docs/specs/SPEC-US-010.md | Pass |
| Plan approved | docs/plans/US-010/ | Pass |
| Red test evidence | docs/testing/US-010/RED-US-010.md | Partial |
...
| Build/lint/test evidence | Run `npm run ai-sdlc:validate -- US-010` after retrofit | Pending |
