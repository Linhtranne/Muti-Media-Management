# AI-SDLC Retrofit Header for US-014
...
|:---|:---|:---|
| Spec approved | docs/specs/SPEC-US-014.md | Pass |
| Plan approved | docs/plans/US-014/ | Pass |
| Red test evidence | docs/testing/US-014/RED-US-014.md | Partial |
...
| Build/lint/test evidence | Run `npm run ai-sdlc:validate -- US-014` after retrofit | Pending |
